...
namespace timerProject
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //The initialise function reverts all controls and variables for the timer to its original value
            ...
            MCDTxtBxRepeat.Text = "1";
            MCDTxtBxRepeat.Enabled = false;
            ...
            MRETxtBxSetHr.Enabled = false;
            MRETxtBxSetMin.Enabled = false;
            MRETxtBxSetSec.Enabled = false;
        ...
        private void comboBoxTabSelection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (selection)
            {
                ...
                case "CountDown":
                    tabControl.SelectedTab = CDTabPage;
                    break;

                case "StopWatch":
                    tabControl.SelectedTab = SWTabPage;
                    break;

                case "Rest Eye Timer":
                    tabControl.SelectedTab = RETabPage;
                    break;
            }
        }
        ...
        private void checkBoxRepeat_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBoxRepeat.Checked == true)
            {
                ...
                MCDTxtBxRepeat.Enabled = true;

                checkBoxRepeat.Checked = true;
                MCDChkBxRepeat.Checked = true;
            }
            ...
            else if (checkBoxRepeat.Checked == false)
            {
                ...
                MCDChkBxRepeat.Checked = false;
            }
        }
        private void MCDChkBxRepeat_CheckedChanged(object sender, EventArgs e)
        {
            if (MCDChkBxRepeat.Checked == true)
            {
                textBoxRepeat.Enabled = true;
                MCDTxtBxRepeat.Enabled = true;
            ...
            else if (MCDChkBxRepeat.Checked == false)
            {
                textBoxRepeat.Enabled = false;
                MCDTxtBxRepeat.Enabled = false;
        ...
        {
            MCDTxtBxRepeat.Text = textBoxRepeat.Text;
        }

        private void MCDTxtBxRepeat_TextChanged(object sender, EventArgs e)
        {
            textBoxRepeat.Text = MCDTxtBxRepeat.Text;
        }

        private void MCDTxtBxChanged(object sender, EventArgs e)
        {
            textBoxHour.Text = MCDTxtBxHR.Text;
            textBoxMin.Text = MCDTxtBxMin.Text;
            textBoxSec.Text = MCDTxtBxSec.Text;
        }

        private void CDTxtBxChanged(object sender, EventArgs e)
        {
            MCDTxtBxHR.Text = textBoxHour.Text;
            MCDTxtBxMin.Text = textBoxMin.Text;
            MCDTxtBxSec.Text = textBoxSec.Text;
        }

        private void MSWTxtBxCHanged(object sender, EventArgs e)
        {
            SWTextBoxHr.Text = MSWTxtBxHr.Text;
            SWTextBoxMin.Text = MSWTxtBxMin.Text;
            SWTextBoxSec.Text = MSWTxtBxSec.Text;
            SWTextBoxMiSec.Text = MSWTxtBxMiSec.Text;
        }

        private void SWTxtBoxChanged(object sender, EventArgs e)
        {
            MSWTxtBxHr.Text = SWTextBoxHr.Text;
            MSWTxtBxMin.Text = SWTextBoxMin.Text;
            MSWTxtBxSec.Text = SWTextBoxSec.Text;
            MSWTxtBxMiSec.Text = SWTextBoxMiSec.Text;
        }

        private void MRETxtBoxChanged(object sender, EventArgs e)
        {
            REtextBoxHr.Text = MRETxtBxHr.Text;
            REtextBoxMin.Text = MRETxtBxMin.Text;
            REtextBoxSec.Text = MRETxtBxSec.Text;
        }

        private void RETxtBoxChanged(object sender, EventArgs e)
        {
            MRETxtBxHr.Text = REtextBoxHr.Text;
            MRETxtBxMin.Text = REtextBoxMin.Text;
            MRETxtBxSec.Text = REtextBoxSec.Text;
        }

        private void MRECheckBxSet_CheckedChanged(object sender, EventArgs e)
        {
            if (MRECheckBxSet.Checked == true)
            {
                RECheckboxSet.Checked = true;

                REtextBoxSetHr.Enabled = true;
                REtextBoxSetMin.Enabled = true;
                REtextBoxSetSec.Enabled = true;

                MRETxtBxSetHr.Enabled = true;
                MRETxtBxSetMin.Enabled = true;
                MRETxtBxSetSec.Enabled = true;
            }

            else if (MRECheckBxSet.Checked == false)
            {
                RECheckboxSet.Checked = false;
        ...
        {
            if (RECheckboxSet.Checked == true)
            {
                MRECheckBxSet.Checked = true;
            ...
            else if (RECheckboxSet.Checked == false)
            {
                MRECheckBxSet.Checked = false;
